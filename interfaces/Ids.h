...
namespace Exchange {
    ...
    enum IDS : uint32_t {
        ...
        ID_FIREBOLT_CONTENTPROGRESS_APPRESUMEPOINT   = ID_FIREBOLT_CONTENTPROGRESS + 1,
        ID_FIREBOLT_CONTENTPROGRESS_APPRESUMEPOINTS_NOTIFICATION = D_FIREBOLT_CONTENTPROGRESS + 2,
