...
namespace Exchange {
    ...
    enum IDS {
        ...
        ID_PROCESSMEMORY = 0x00000053,
        ID_MEMORYEXTENDED = 0x00000054,

        ID_NETFLIX = 0x00000055,
        ID_NETFLIX_NOTIFICATION = 0x00000056,
        ID_CONTENTDECRYPTION = 0x00000057,
        ID_PROVISIONING = 0x00000058,
        ID_PROVISIONING_NOTIFICATION = 0x00000059,
