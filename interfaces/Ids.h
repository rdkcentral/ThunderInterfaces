...
namespace Exchange {
    ...
    enum IDS : uint32_t {
        ...
        ID_FIREBOLT_CONTENTPROGRESS                  = RPC::IDS::ID_EXTERNAL_INTERFACE_OFFSET + 0x4F0,
        ID_FIREBOLT_CONTENTPROGRESS_APPRESUMEPOINTS  = ID_FIREBOLT_CONTENTPROGRESS + 1,
        ID_FIREBOLT_CONTENTPROGRESS_APPRESUMEPOINTS_NOTIFICATION = ID_FIREBOLT_CONTENTPROGRESS + 2,
        ID_FIREBOLT_CONTENTPROGRESS_APPRESUMEPOINTS_RESUMEPOINTINFO_ITERATOR = ID_FIREBOLT_CONTENTPROGRESS + 3
