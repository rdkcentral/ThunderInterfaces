...
namespace QualityAssurance {
    ...
    enum IDS : uint32_t {
        ...
        ID_PERCALLSIGNREGISTRATION_ISHELL_TEST         = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x070,
        ID_PERCALLSIGNREGISTRATION_ICONTROLLER_TEST    = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x071
    };
}
}
